    ...
    <div className="absolute inset-0 pointer-events-none select-none z-10 p-4 md:p-6 flex flex-col justify-between">
      ...
      <div className="w-full flex flex-row justify-between items-start">
        ...
        <div className="flex flex-col items-start gap-2 pointer-events-auto">
          ...
          <div 
            className="bg-[#2e1d11] border-4 border-[#614126] rounded-xl p-2 px-3 shadow-xl flex flex-row items-center gap-2.5 relative z-10 pointer-events-auto max-w-[220px] md:max-w-[240px]"
          ...
          >
            ...
            <div className="relative shrink-0">
              ...
              {hasWater && (
                <span className="absolute -top-1.5 -right-1 text-[7px] bg-sky-500 border border-white rounded-full text-white px-1 font-bold animate-bounce leading-none py-0.5">
                  FULL
                </span>
              )}
            </div>
            ...
            <div className="flex min-w-0 flex-1 flex-col">
              <div className="flex flex-row justify-between items-end mb-1 font-press-start text-[8px] md:text-[9px] gap-2">
              ...
              <div className="w-full h-3.5 bg-slate-950 border-2 border-slate-800 rounded-md overflow-hidden p-0.5">
                <motion.div
